...
def http = new HTTPBuilder("http://192.168.123.55")
http.request(POST, TEXT) { req ->
    uri.path='/service/extdirect'
    headers.'Content-Type'="application/json"
    headers.'Accept'="*/*"
    body = """{ "action":"coreui_Component", "method":"readAssets","data":[{"page":"1","start":"0","limit":"300","sort":[{"property":"name","direction":"ASC"}],"filter":[{"property":"repositoryName","value":"artifact_storage_semirski"}]}],"type":"rpc","tid":15 } """
