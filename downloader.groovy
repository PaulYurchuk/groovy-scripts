...
def httpreq =  """ { "action": "coreui_Component",    
    ...
    "filter":[{"property":"repositoryName","value":"artifact_storage_semirski"}]}],
    "type":"rpc",
    "tid":15
    } """
def remote = new HTTPBuilder("http://192.168.123.55:8081")
...
remote.request(POST, TEXT) { req ->
    ...
    def cl = response.success = { resp, json ->
        ...
        download("http://192.168.123.55:8081/repository/artifact_storage_semirski/"+listArtifacts[-1], "./artifact.tar.gz")
    }
    cl
}
